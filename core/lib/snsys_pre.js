        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    hSN.setEnc(function (d) { return String(AES.encrypt(d, pbkdf2, { iv: iv })); });
                    hSN.getStK(function () { return p.stk; });
                    hSN.getHash(function (d) { return RIPEMD160(d).toString(enc.Hex); });
                    return [2 /*return*/];
            }
        });
    });
