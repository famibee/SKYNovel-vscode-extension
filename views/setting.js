...
const builtInSymbols = new Set(/* @__PURE__ */ Object.getOwnPropertyNames(Symbol).map((key) => Symbol[key]).filter(isSymbol$4));
...
cmd2Ex({ cmd: "?" });
const oVSCode = (_a = vscode == null ? void 0 : vscode.getState()) != null ? _a : {
  active_tab: "basic"
};
let init$2 = false;
const useVSCode = () => {
  ...
  if (!init$2) {
    init$2 = true;
    st.$subscribe(() => vscode == null ? void 0 : vscode.setState(oVSCode));
    const stCfg = useCfg();
    on("!", (data) => {
...
function useCheckboxField(name, rules, opts) {
  ...
  function patchCheckboxApi(field) {
    ...
    function handleCheckboxChange(e, shouldValidate = true) {
      var _a2, _b;
      if (checked.value === ((_b = (_a2 = e) === null || _a2 === void 0 ? void 0 : _a2.target) === null || _b === void 0 ? void 0 : _b.checked)) {
        return;
      }
...
(() => {
  var t = { 90: (t2, e2, i2) => {
    i2.d(e2, { Z: () => n });
    var s = i2(645), o = i2.n(s)()(function(t3) {
      return t3[1];
    });
  ...
  i.n = (t2) => {
    ...
    class d extends HTMLElement {
      constructor() {
        super(), this.exposure = this.hasAttribute("value") ? parseFloat(this.getAttribute("value")) : 50, this.slideOnHover = false, this.slideDirection = "horizontal", this.isMouseDown = false, this.isFocused = false, this.onMouseMove = (t3) => {
          ...
          if (!this.hasTouchMoved) {
            ...
            if (this.slideDirection === "horizontal" && i3 < s2 || this.slideDirection === "vertical" && i3 > s2)
          ...
          const e4 = t3.key;
          o[e4] !== void 0 && this.startSlideAnimation(o[e4]);
        }, this.onKeyUp = (t3) => {
          this.isAnimating && o[t3.key] !== void 0 && this.stopSlideAnimation();
      ...
      set hover(t3) {
        this.slideOnHover = t3.toString().toLowerCase() !== "false", this.removeEventListener("mousemove", this.onMouseMove), this.slideOnHover && this.addEventListener("mousemove", this.onMouseMove);
      }
      get direction() {
      ...
      slideToPage(t3) {
        this.slideDirection === "horizontal" && this.slideToPageX(t3.x), this.slideDirection === "vertical" && this.slideToPageY(t3.y);
      }
      slideToPageX(t3) {
    ...
    typeof window != "undefined" && window.customElements.define("img-comparison-slider", d);
  })();
})();
...
var StgImgOpt_vue_vue_type_style_index_0_lang = "";
                    ...
                    (openBlock(true), createElementBlock(Fragment, null, renderList(sortHSize(), (e) => {
                      ...
                      return openBlock(), createElementBlock(Fragment, {
                        ...
                        createBaseVNode("tr", {
                          ...
                          createBaseVNode("td", {
                            textContent: toDisplayString((_a2 = e.webp_q) != null ? _a2 : `${unref(oWss)["cnv.mat.webp_quality"]} (\u57FA\u672C\u306E\u5024)`)
